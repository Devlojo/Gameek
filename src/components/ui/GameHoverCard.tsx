...
export const GameHoverCard = ({ platforms, genres, info }: TGame) => {
  return (
    <div className="inset-0 hidden flex-col items-center justify-center gap-3 bg-global/75 opacity-0 transition duration-200 ease-in-out group-hover:opacity-100 lg:absolute lg:flex">
